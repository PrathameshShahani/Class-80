...
import {Alert, SafeAreaView, Text,View,FlatList,StyleSheet,ImageBackground,Image, Dimensions,StatusBar,Platform} from 'react-native';
...
export default class MeteorScreen extends Component{
    ...
    getMeteors=()=>{
        axios
        .get("https://api.nasa.gov/neo/rest/v1/feed?api_key=AnLUML4jsvy9xo4a26UMm9N8BlzPRPxbphwAuesl")
        .then(response =>{
            this.setState({
